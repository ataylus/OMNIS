...
which holds 6 policies and 15 requirements: the 3
...
low-confidence threshold = 0.6. Mappable rows reference the
15 requirement ids parsed from the synthetic policy
